...
// CUSTOMIZE: credits shown in the "Credits" desktop app.
// NOTE: The site template, 3D scene, models, and sound were created by Henry
// Heffernan and collaborators — please keep those attributions intact.
const CREDITS = [
    {
        title: 'Content & Customization',
        rows: [['Aryan Jalota', 'Portfolio content & build']],
    },
    {
        title: 'Original Site & Design',
        rows: [
            ['Henry Heffernan', 'Original portfolio engineering & design'],
            ['henryheffernan.com', 'Template'],
        ],
    },
    {
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={
                '© 2026 Aryan Jalota · Original site © Henry Heffernan'
            }
        >
            <div
            ...
            >
                <h2>Credits</h2>
                <p>Aryan Jalota, 2026 · adapted from henryheffernan.com</p>
                <br />
                <br />
                <br />
