...
const Wordle: React.FC<WordleProps> = () => {
    // CUSTOMIZE: the secret word (must be 5 letters to match the board layout)
    const word = 'ARYAN';
    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                <h2>Aryordle</h2>
                <p>Wordle but with an ARYAN based twist.</p>
            </div>
            <motion.div
            ...
            >
                ...
                <p>Thanks for playing! Remember: the word is always "ARYAN"!</p>
                <br />
                <GuessWord
                    key={'winning-guess'}
                    guess={word}
